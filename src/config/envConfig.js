...
export const url = import.meta.env.VITE_URL || 'https://api.megyai.com/api/v1/';
export const pdfUrl = import.meta.env.VITE_PDF_URL || 'https://api.megyai.com';
export const imageUrl = import.meta.env.VITE_IMAGE_URL || 'https://api.megyai.com/uploads';
